const kCountries = [
    ...
    { turnOrder: 9, code: "ab", flatName: "amberblossom", name: "Amber Blossom" },
...
function normalizeUnitName(name) {
    if (!name) return "";
    let clean = name.toLowerCase().replace(" ", "").replace("-", "").replace(".", "").replace("_", "");
    return kUnitNameAliases[clean] || name;
}
