...
class Unit {
    ...
    static fromElement(element) {
        ...
        let normalized = normalizeUnitName(remainder);
        console.log("AWBW Enhancements - Parsed unit element:", {
            id: id,
            remainder: remainder,
            normalized: normalized,
            hp: hp,
            srcs: srcs,
            unitData: kUnitsByName[normalized]
        });
        return new Unit(element, country, normalized, coords, hp, is_waited, others);
    }
